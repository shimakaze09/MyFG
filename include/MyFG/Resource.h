...
struct ResourceImplDesc {
  const void*
      impl_type;  // e.g. D3D12_SHADER_RESOURCE_VIEW_DESC / D3D12_RENDER_TARGET_VIEW_DESC
  size_t
      raw_state;  // e.g. D3D12_SHADER_RESOURCE_VIEW_DESC / D3D12_RENDER_TARGET_VIEW_DESC
};
